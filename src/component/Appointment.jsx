...
export const Appointment = () => {
	...
	const sendEmail = (e) => {
		...
		setisLoading(true);
		emailjs
			.sendForm('service_1zn6l5c', 'template_m3taohm', form.current, {
				publicKey: 'vcTBwtQMEPVIa2Q9t',
	...
	// 	e.preventDefault();
	// 	emailjs
	// 		.sendForm('service_1zn6l5c', 'template_w0jjb2i', form.current, {
	// 			publicKey: 'vcTBwtQMEPVIa2Q9t',
	// 		})
	// 		.then(
	// 			() => {
	...
	return (
		...
		<>
			<section id='services' className='services section'>
				...
				<div className='grid sm:grid-cols-2 items-start gap-16 p-2  mx-auto max-w-4xl bg-white font-[sans-serif]'>
					<div>
						<h3 className='text-gray-800 text-2xl font-extrabold'>
							Let's meet
						</h3>
							...
							<ul className='mt-4'>
								<li className='flex items-center'>
									...
									>
										...
										<strong>ainapercky@gmail.com</strong>
									</a>
								</li>
							</ul>
						</div>
